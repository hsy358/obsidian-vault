...
url: "https://mp.weixin.qq.com/s/vejqEv5hACcbT15b4Xe5LQ"
---

---
title: "AI Agent时代的软件开发范式"
author: "张铁蕾"
publish_date: "2025-07-19 21:47:55"
saved_date: "2026-06-26"
source: "wechat"
url: "https://mp.weixin.qq.com/s/vejqEv5hACcbT15b4Xe5LQ"
---
# AI Agent时代的软件开发范式
大概一个多月之前，我们曾经深入讨论了[AI Agent自主性的本质](https://mp.weixin.qq.com/s?__biz=MzA4NTg1MjM0Mg==&mid=2657262020&idx=1&sn=e4e4cfed39c3db2e32fa2c7a17135c58&scene=21#wechat_redirect)是什么。今天，我们沿着这个话题更进一步，去探究一下AI Agent的自主性这一本质特性，可能会对新时代的软件开发工作带来什么样的影响。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/qR4rtg9Wfeia11sxLEony5Hjg6vnXodpsF3xICGqrAFfF6umgFA3sEq2eico1lm7ibgdxC8GW2RdXIiaDkz47iceSNw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/qR4rtg9Wfeia11sxLEony5Hjg6vnXodpsAyAZ8p4uLEpgnMiaKBSxEF0k3VwCXrm3nbMls348RzIaCuyRz3CpFQg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/qR4rtg9Wfeia11sxLEony5Hjg6vnXodpsEFKAa0178Qvh4xlS3LjqmYoALxTjz7Wj1pIMMQnt13OVZJKXrQ8DnA/640?wx_fmt=png&from=appmsg)
...
所有这些方案的底层架构，是基于或至少「类似于」Pregel的 (谷歌总结出来的一种分布式图计算架构[5]) 。如果不考虑分布式计算的部分，Pregel在编排逻辑上跟手写代码的if/else、while本质上是一回事，因为工程师需要手工编码程序执行的每一个step。我们在上一篇文章《[开发AI Agent到底用什么框架——LangGraph VS. LlamaIndex](https://mp.weixin.qq.com/s?__biz=MzA4NTg1MjM0Mg==&mid=2657262035&idx=1&sn=b7ec96ae1c312bcb0edb9cff873642f2&scene=21#wechat_redirect)》中曾经讨论过，Pregel通过在每一个superstep末尾发送动态消息，让它具备了**动态编排**的特性。当然，所有可能的执行逻辑和可能的执行路径，是提前预设好的（在程序执行前确定好的）。
...
我们再重温一下[之前的文章](https://mp.weixin.qq.com/s?__biz=MzA4NTg1MjM0Mg==&mid=2657262020&idx=1&sn=e4e4cfed39c3db2e32fa2c7a17135c58&scene=21#wechat_redirect)中得到的一个重要结论：各种不同的Agentic System，它们所呈现出来的不同程度的自主性，本质在于**系统编排的执行路径是在何时决策的**。总共分成三种编排时机：
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/qR4rtg9Wfeia11sxLEony5Hjg6vnXodpsicLiavAcI3O0PTOIeUQOEHuOQqjsgczjnHiche5iafdp3oXcgYet0ek7zQ/640?wx_fmt=png&from=appmsg)
...
参考文献：- [1] Dex Horthy. How We Got Here: A Brief History of Software. (https://github.com/humanlayer/12-factor-agents/blob/main/content/brief-history-of-software.md)
...
```
AI Agent的概念、自主程度和抽象层次科普一下：拆解LLM背后的概率学原理开发AI Agent到底用什么框架
```
