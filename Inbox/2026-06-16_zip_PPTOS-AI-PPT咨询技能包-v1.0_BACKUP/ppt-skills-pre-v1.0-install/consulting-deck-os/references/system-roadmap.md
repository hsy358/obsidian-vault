...
2. Use `consulting-deck-os` to define storyline and slide plan.
3. Use `editable-architecture-ppt` for dense visual pages.
4. Use `ppt-production-engine` to compile the editable PPTX.
5. Use `ppt-quality-review` before claiming delivery readiness.
