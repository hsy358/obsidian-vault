...
author: "量子位"
publish_date: "2026-08-21 12:51:43"
saved_date: "2026-08-23"
source: "wechat"
url: "https://mp.weixin.qq.com/s/9N_86XvCn-pJAvgmKNHhbQ"
---
# 开源国产8B模型，比肩闭源Image 2了！
金磊 发自 凹非寺
量子位 | 公众号 QbitAI时隔仅仅**三周**，国产生图模型，又进化了。

[上回书到](https://mp.weixin.qq.com/s?__biz=MzIzNjc1NzUzMw==&mid=2247909395&idx=1&sn=4429179fb6656c125179b9fd1abf7024&scene=21#wechat_redirect)，这个生图模型是4K直出的，开源的，只有8B大小的。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGF2Nm5r8jAJ5NmCM1rTZO1nDTABqVBqIO9BoibiaicTnnFwf9GLouggU2ibb66t9fGXoiayULzWCKIaCw3PIBobKGPSORaCfWibu2vicg/640?wx_fmt=png&from=appmsg)

并简单附上一句Prompt：

> 请将这九款美食拼成一张精美的食谱分享卡片。

![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGSKfLHZrRPm92icqwzLn2YUiaecibObAwCxorNLYNmMkMH2hIpZAdIOVvyluf0TIrCHqRpJFq7ETdJdtdc2aYQX6fzhTvhxXzd1g/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHA6sWG7td941ibmQpABUPbonvzRO7IWEDvTE3YibZGadibnI7iaGVHMFKu23nw8YYBcghZEC13xiczfQzYGJIDlRIhgnwgJ2GgAUibk/640?wx_fmt=png&from=appmsg)

AI在接到任务改完以后是这样：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGFYMrHRKvZ8Cia8f7QBBJnLm6WDvicnazHibIRJWPXwO4kUiapsbEcqUjecCVpGz0E2qVEh7rqOibzgqCtIibob79YE9BkvPROXmjocI/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHQa2ice1XKV20ExKmXme1UHo4AmlSwlkZUGibm2yOne3wibCqibvYFdgWsrFjsY5VuoXlgpXRianZqZCqD0Wibo7LYmbibia7egHiaLE78/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGEthXwGd2yrSh0RmqibIsSxoJs1z8NkhD8hvpwMhzhYPmHdyE7XQ4bXyjqssoEEOTLUwGHvJrYDl7O1EYPmLWWz2iclAezM3b0Q4/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGHeD4KXgRQHSEXvOfIeDKdZyFDv9Nrm144z1GcoY3R1Q9XLiccHY89iccaod5rEennoomnhfTdW33KBroehArAj1n5RobR7rsJmI/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGHT6Vhia6slpSZUWbOYha9LepI0x64YJqxgQztN9hCHPIyeAQkXSEoOBiaUTpQugL6vBsFcWZiaDzxfJou5J1z5Ysw5L2uoD537icI/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A6fTew8FFGGmaGObeeibqIyUH0fOEGTJ9icGYVq2y5jyYazdm8F7ialog57OxPdI1fm5N2GdOovK1Zx6YnZVkZguFKw2pdd0KHz2GW10qldUVo/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGFhictibbZ3NSkHNVh9ApicI5L5TyjXic2ibnicvDaoqICMusb5jte0qcicNicRYyUEGPZEDcO61XCjS9d1KdXWL9BkEq3vHnbic6z3BPOY/640?wx_fmt=png&from=appmsg)
...
> 请将左下角深蓝色矩形信息栏内的展览时间与地址详情，从“JUNE 15 - JULY 30, 2024URBAN GALLERY123 CREATIVE WAYARTSVILLE, USA”替换为“AUGUST 10 -SEPTEMBER 28, 2024METRO MUSEUM456 DESIGN ROADCREATIVITY CITY, UK”，保持原有的白色与粉色字体样式及排版布局不变。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/A6fTew8FFGFIzt14sfBibksLVH4YicH1eXfv9UxNuy3OKaniceLIqiaUy2wYLwXFNzibG7SaYGze2ibSHMUgiaiaria2hBU0h9s2OTryM6Vk7gOAWE5k/640?wx_fmt=png&from=appmsg)
...
据了解，SenseNova U1.5 Lite继续沿用了**NEO-unify原生统一多模态架构**，把视觉理解、图像生成和编辑放在同一套模型里。

也就是说，在真正动像素之前，模型先要理解画面。

哪里是主体，谁在谁旁边，哪些是文字，用户指的是哪块区域，一张参考图里到底哪些东西值得保留……这些理解过程，并不会和后面的生成、编辑彻底分家。

而正式版这次比较关键的一处变化，发生在**训练阶段**。商汤采用了一套很容易理解的办法：**先拆开练，再合回来。**

文字渲染、美学表达、图像编辑这些目标，先会分别训练对应的**专项Expert**。

等这些Expert练完以后，再通过多教师在线策略蒸馏技术**MOPD**，把它们的专项能力重新融合回同一个SenseNova U1.5 Lite里。
...
第一件叫**指令遵循**。用户写了一大串要求，主体有几个、谁在左边、文字放哪儿、什么颜色、哪些东西不许改，最后模型到底执行了多少。

第二件叫**视觉偏好**。指令都完成以后，整张图的构图、材质、光影和最终质感到底过不过关。

第三件是**编辑保持**。要改的区域能不能改准，原本已经正确的地方还能不能留下来。

这三项其实刚好对应了前面几个案例最容易出问题的地方：复杂信息图怕漏要求，STYLE这样的封面直接考验美学完成度，而卧室修改、Radiohead和文字替换，则都离不开对非编辑区域的保持。

另外还有**提示词增强**。如果用户只给一句比较简短的需求，PE可以先帮忙把意图整理成更完整的创作方案，再交给U1.5 Lite执行。
