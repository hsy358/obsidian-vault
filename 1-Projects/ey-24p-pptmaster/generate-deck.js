...
const PROJECT_DIR = path.join("/root/vault", "1-Projects", "ey-24p-pptmaster");
const slidesData = JSON.parse(fs.readFileSync(path.join(PROJECT_DIR, "slides.json"), "utf-8"));
...
async function main() {
  ...
  const outputPath = path.join(PROJECT_DIR, "ey-24p-pptmaster-editable.pptx");
