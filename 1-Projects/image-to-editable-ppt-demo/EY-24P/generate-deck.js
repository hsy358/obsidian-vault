...
const slidesData = JSON.parse(
  fs.readFileSync(
    path.join(VAULT, "1-Projects", "image-to-editable-ppt-demo/EY-24P", "slides.json"),
    "utf-8"
  )
);
...
// 2. 主题常量（EY 风格）
// ============================================================
const ICONS_DIR = path.join(VAULT, "1-Projects", "image-to-editable-ppt-demo/EY-24P", "icons");
...
async function main() {
  ...
  const outputPath = path.join(
    VAULT,
    "1-Projects", "image-to-editable-ppt-demo", "EY-24P",
    "EY-24P-editable.pptx"
  );
