...
const slidesData = JSON.parse(
  fs.readFileSync(
    path.join(VAULT, "1-Projects", "ey-24p-v5-strict", "slides.json"),
    "utf-8"
  )
);
...
// 2. 主题常量（EY 风格）
// ============================================================
const ICONS_DIR = path.join(VAULT, "1-Projects", "ey-24p-v5-strict", "icons");
...
async function main() {
  ...
  slidesData.slides.slice(0, 4).forEach((page) => {
  ...
  const outputPath = path.join(
    VAULT,
    "1-Projects", "ey-24p-v5-strict",
    "ey-24p-v5-strict.pptx"
  );
